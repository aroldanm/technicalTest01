...
class ProductListAdapterImpl: ProductListAdapter {
...
private extension ProductListAdapterImpl {
    func toProduct(from item: ProductEntity) -> Product? {
